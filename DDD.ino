...
int sens = 300; // started at 90 // higher = less sensitive (~500 seems okay for not flush to monitor, eventually decrease)
...
//  doc["Dropouts"] = (String) dropouts;
  doc["Message"] = "A dropout occurred at " + (String) runtime + " minute(s) into test.";
  doc["Total Dropouts"] = (String) dropouts;
  char jsonBuffer[512];
